            ...
            <div class="space-y-3">
                ...
                <div class="space-y-2.5">
                    <input type="text" name="option_a" placeholder="Option A" value="{{ old('option_a') }}"
                           class="w-full px-4 py-2.5 bg-slate-800/80 border border-slate-700 rounded-2xl text-slate-100 text-sm focus:bg-slate-800 focus:ring-2 focus:ring-indigo-500 transition font-medium" required>
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                ...
                <div>
                    ...
                    <input type="number" name="points" min="1" value="{{ old('points', 1) }}"
                           class="w-full px-4 py-2.5 bg-slate-800/80 border border-slate-700 rounded-2xl text-slate-100 text-sm focus:bg-slate-800 focus:ring-2 focus:ring-indigo-500 transition font-bold" required>
                </div>
            </div>
