...
<div class="space-y-8">
    ...
    <div class="flex flex-col sm:flex-row sm:items-center justify-between gap-4 glass-panel rounded-3xl p-6 sm:p-8 shadow-xl">
        <div>
            <div class="flex items-center gap-3.5">
                ...
                <div>
                    <h1 class="text-2xl font-extrabold text-white tracking-tight font-heading">Question Bank</h1>
        ...
        <div class="flex flex-wrap items-center gap-3">
            ...
            <a href="{{ route('questions.create', $quiz->id) }}"
               class="inline-flex items-center gap-2 px-4 py-2.5 rounded-2xl bg-gradient-to-r from-indigo-500 to-purple-600 text-white font-bold text-xs shadow-lg shadow-indigo-500/30 hover:scale-[1.02] active:scale-95 transition-all">
                <i class="fas fa-plus"></i>
                <span>Add Question</span>
            </a>

            <a href="{{ route('questions.create', $quiz->id) }}#bulk-upload"
               class="inline-flex items-center gap-2 px-4 py-2.5 rounded-2xl bg-gradient-to-r from-purple-500 to-pink-600 text-white font-bold text-xs shadow-lg shadow-purple-500/30 hover:scale-[1.02] active:scale-95 transition-all">
    ...
    <!-- Capacity Info Bar -->
    <div class="p-4 glass-card rounded-2xl flex flex-col sm:flex-row items-center justify-between gap-3 text-xs text-slate-300 shadow-md">
    ...
    <div class="space-y-4">
        ...
        <div class="glass-panel rounded-3xl p-6 shadow-xl hover:border-indigo-500/30 transition-all duration-200">
            <!-- Question Header -->
                ...
                <div class="flex items-start gap-3">
                    ...
                    <div>
                        ...
                        <div class="flex items-center gap-2 mt-2">
                            ...
                            <span class="px-3 py-0.5 rounded-full text-[10px] font-bold bg-emerald-500/20 text-emerald-400 border border-emerald-500/30">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-3 text-xs font-medium">
                <div class="p-3.5 rounded-2xl border transition-all flex items-center justify-between {{ $correct === 'A' ? 'bg-emerald-500/10 border-emerald-500/30 text-emerald-300' : 'bg-slate-800/50 border-slate-700/60 text-slate-300' }}">
                    <div>
                ...
                <div class="p-3.5 rounded-2xl border transition-all flex items-center justify-between {{ $correct === 'B' ? 'bg-emerald-500/10 border-emerald-500/30 text-emerald-300' : 'bg-slate-800/50 border-slate-700/60 text-slate-300' }}">
                    <div>
                ...
                <div class="p-3.5 rounded-2xl border transition-all flex items-center justify-between {{ $correct === 'C' ? 'bg-emerald-500/10 border-emerald-500/30 text-emerald-300' : 'bg-slate-800/50 border-slate-700/60 text-slate-300' }}">
                    <div>
                ...
                <div class="p-3.5 rounded-2xl border transition-all flex items-center justify-between {{ $correct === 'D' ? 'bg-emerald-500/10 border-emerald-500/30 text-emerald-300' : 'bg-slate-800/50 border-slate-700/60 text-slate-300' }}">
                    <div>
        ...
        <div class="glass-panel rounded-3xl p-12 text-center text-slate-400 border border-slate-800">
            ...
            <a href="{{ route('questions.create', $quiz->id) }}"
               class="inline-flex items-center gap-2 px-5 py-2.5 bg-indigo-600 hover:bg-indigo-700 text-white font-bold text-xs rounded-2xl shadow-lg shadow-indigo-600/30 transition">
