    ...
    <div class="flex flex-col sm:flex-row sm:items-center justify-between gap-4 glass-panel rounded-3xl p-6 sm:p-8 shadow-xl">
        <div>
            <div class="flex items-center gap-3.5">
                <div class="w-12 h-12 rounded-2xl bg-purple-500/20 border border-purple-500/30 text-purple-400 flex items-center justify-center font-bold shadow-inner">
        ...
        <form action="{{ route('questions.update', [$quiz->id, $question->id]) }}" method="POST" class="space-y-5">
            ...
            <div class="space-y-3">
                ...
                <div class="space-y-2.5">
                    <input type="text" name="option_a" class="w-full px-4 py-2.5 bg-slate-800/80 border border-slate-700/80 rounded-2xl text-slate-100 text-sm focus:bg-slate-800 focus:ring-2 focus:ring-indigo-500 font-medium placeholder-slate-500"
                           value="{{ old('option_a', $question->option_a) }}" placeholder="Option A" required>
                    <input type="text" name="option_b" class="w-full px-4 py-2.5 bg-slate-800/80 border border-slate-700/80 rounded-2xl text-slate-100 text-sm focus:bg-slate-800 focus:ring-2 focus:ring-indigo-500 font-medium placeholder-slate-500"
                           value="{{ old('option_b', $question->option_b) }}" placeholder="Option B" required>
                    <input type="text" name="option_c" class="w-full px-4 py-2.5 bg-slate-800/80 border border-slate-700/80 rounded-2xl text-slate-100 text-sm focus:bg-slate-800 focus:ring-2 focus:ring-indigo-500 font-medium placeholder-slate-500"
                           value="{{ old('option_c', $question->option_c) }}" placeholder="Option C" required>
                    <input type="text" name="option_d" class="w-full px-4 py-2.5 bg-slate-800/80 border border-slate-700/80 rounded-2xl text-slate-100 text-sm focus:bg-slate-800 focus:ring-2 focus:ring-indigo-500 font-medium placeholder-slate-500"
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                ...
                <div>
                    ...
                    <input type="number" name="points"
                           class="w-full px-4 py-2.5 bg-slate-800/80 border border-slate-700/80 rounded-2xl text-slate-100 text-sm focus:bg-slate-800 focus:ring-2 focus:ring-indigo-500 font-bold"
