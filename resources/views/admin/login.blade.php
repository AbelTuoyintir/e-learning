...
<body class="h-full antialiased selection:bg-indigo-500 selection:text-white ambient-glow flex items-center justify-center p-4 sm:p-6 lg:p-8">
    ...
    <!-- Container Card -->
    <div class="w-full max-w-5xl bg-slate-900/90 backdrop-blur-2xl rounded-3xl shadow-2xl overflow-hidden border border-slate-800 grid grid-cols-1 lg:grid-cols-12 min-h-[620px]">

        <!-- Left Visual Feature Section -->
        <div class="lg:col-span-6 relative bg-gradient-to-br from-slate-950 via-indigo-950 to-slate-900 p-8 sm:p-12 text-white flex flex-col justify-between overflow-hidden border-b lg:border-b-0 lg:border-r border-slate-800">
            ...
            <div class="relative z-10 my-8 space-y-6">
                <div class="inline-flex items-center gap-2 px-3.5 py-1.5 rounded-full bg-indigo-500/10 backdrop-blur-md border border-indigo-500/20 text-indigo-300 text-xs font-semibold">
                ...
                <p class="text-indigo-200/80 text-sm leading-relaxed">
                    Streamline course creation, monitor student progression in real time, and deliver AI-assisted tutoring experiences from one centralized control center.
                </p>

                <div class="grid grid-cols-3 gap-3 pt-4 border-t border-slate-800 text-center">
                    <div class="p-3 rounded-2xl bg-slate-800/50 backdrop-blur-md border border-slate-700/50">
                    ...
                    <div class="p-3 rounded-2xl bg-slate-800/50 backdrop-blur-md border border-slate-700/50">
                        <p class="text-lg font-extrabold text-white font-heading">2.5</p>
                        <p class="text-[10px] text-indigo-300 font-medium">Engine v2.5</p>
                    </div>
                </div>
            </div>
            ...
            <div class="relative z-10 text-xs text-slate-400">
                &copy; {{ date('Y') }} LMS Platform. All administrative sessions are encrypted & audited.
            </div>
        </div>

        <!-- Right Login Form Section -->
        <div class="lg:col-span-6 p-8 sm:p-12 flex flex-col justify-center bg-slate-900/60 backdrop-blur-xl">
                    ...
                    <div class="space-y-1.5">
                        ...
                        <div class="relative">
                            ...
                            <input type="email" id="email" name="email" value="{{ old('email') }}" required autofocus
                                   class="w-full pl-10 pr-4 py-3 bg-slate-800 border border-slate-700 rounded-2xl text-slate-100 text-sm focus:bg-slate-800 focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500 transition-all font-medium placeholder-slate-500"
