...
<head>
    ...
    <title>Admin Sign In - LMS Control Center</title>
...
<body class="h-full antialiased selection:bg-indigo-500 selection:text-white ambient-glow flex items-center justify-center p-4 sm:p-6 lg:p-8">
    ...
    <!-- Container Card -->
    <div class="w-full max-w-5xl glass-panel rounded-3xl overflow-hidden grid grid-cols-1 lg:grid-cols-12 min-h-[620px] border border-slate-800">

        <!-- Left Visual Feature Section -->
        <div class="lg:col-span-6 relative bg-gradient-to-br from-slate-950 via-indigo-950/90 to-slate-900 p-8 sm:p-12 text-white flex flex-col justify-between overflow-hidden border-b lg:border-b-0 lg:border-r border-slate-800">
            ...
            <div class="relative z-10 flex items-center space-x-3">
                <div class="w-11 h-11 rounded-2xl bg-gradient-to-tr from-indigo-500 to-purple-500 flex items-center justify-center shadow-lg shadow-indigo-500/30 border border-indigo-400/30">
            ...
            <div class="relative z-10 my-8 space-y-6">
                <div class="inline-flex items-center gap-2 px-3.5 py-1.5 rounded-full bg-indigo-500/20 backdrop-blur-md border border-indigo-500/30 text-indigo-200 text-xs font-semibold">
                ...
                <div class="grid grid-cols-3 gap-3 pt-4 border-t border-slate-800 text-center">
                    <div class="p-3 rounded-2xl bg-slate-900/60 backdrop-blur-md border border-slate-800">
                    ...
                    <div class="p-3 rounded-2xl bg-slate-900/60 backdrop-blur-md border border-slate-800">
                        ...
                        <p class="text-[10px] text-indigo-300 font-medium">Engine</p>
                    </div>
                </div>
            </div>
        ...
        <div class="lg:col-span-6 p-8 sm:p-12 flex flex-col justify-center bg-slate-900/60 backdrop-blur-2xl">
            ...
            <div class="max-w-md mx-auto w-full space-y-6">
                ...
                <form method="POST" action="{{ route('admin.login.submit') }}" class="space-y-4">
                    ...
                    <div class="space-y-1.5">
                        ...
                        <div class="relative">
                            ...
                            <input type="email" id="email" name="email" value="{{ old('email') }}" required autofocus
                                   class="w-full pl-10 pr-4 py-3 bg-slate-950/80 border border-slate-700/80 rounded-2xl text-slate-100 text-sm focus:bg-slate-950 focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500 transition-all font-medium"
                    ...
                    <!-- Submit Button -->
                    <button type="submit" class="w-full py-3.5 px-6 rounded-2xl bg-gradient-to-r from-indigo-600 to-purple-600 text-white font-bold text-sm shadow-lg shadow-indigo-600/25 hover:shadow-indigo-600/40 hover:scale-[1.01] active:scale-95 transition-all duration-200 border border-indigo-400/30">
