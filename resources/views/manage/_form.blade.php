...
<div class="space-y-6">
    ...
    <div>
        ...
        <textarea name="description" rows="3"
                  placeholder="Provide a concise overview of what concepts this quiz evaluates..."
                  class="w-full px-4 py-3 bg-slate-800/80 border border-slate-700 rounded-2xl text-slate-100 text-sm focus:bg-slate-800 focus:ring-2 focus:ring-indigo-500 transition font-medium">{{ old('description', $quiz->description ?? '') }}</textarea>
    </div>
    ...
    <div>
        ...
        <label
            for="image-upload"
            class="group relative flex flex-col items-center justify-center w-full h-36 border-2 border-dashed border-slate-700/80 rounded-2xl cursor-pointer hover:border-indigo-500 hover:bg-slate-800/50 transition">
            <div class="w-10 h-10 rounded-xl bg-slate-800 border border-slate-700 group-hover:bg-indigo-600/20 text-slate-400 group-hover:text-indigo-400 flex items-center justify-center mb-1.5 transition">
    ...
    <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
        ...
        <div>
            ...
            <select name="course_id" required
                    class="w-full px-4 py-2.5 bg-slate-800/80 border border-slate-700 rounded-2xl text-slate-100 text-sm focus:bg-slate-800 focus:ring-2 focus:ring-indigo-500 transition font-medium">
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
        ...
        <div>
            ...
            <select name="difficulty"
                    class="w-full px-4 py-2.5 bg-slate-800/80 border border-slate-700 rounded-2xl text-slate-100 text-sm focus:bg-slate-800 focus:ring-2 focus:ring-indigo-500 transition font-medium capitalize">
        ...
        <div>
            ...
            <input type="number" name="question_limit" min="1" max="1000" required
                   ...
                   class="w-full px-4 py-2.5 bg-slate-800/80 border border-slate-700 rounded-2xl text-slate-100 text-sm focus:bg-slate-800 focus:ring-2 focus:ring-indigo-500 transition font-medium">
            <p class="text-[11px] text-slate-400 mt-1">Maximum questions stored in this bank (e.g. 60).</p>
        </div>
    </div>
    ...
    <div class="pt-4 border-t border-slate-800 flex items-center justify-end gap-3">
        <a href="{{ route('quizzes.index') }}" class="px-5 py-2.5 rounded-2xl border border-slate-700/80 bg-slate-800 text-slate-300 font-bold text-xs hover:bg-slate-700 transition">
            Cancel
        </a>
        <button type="submit"
