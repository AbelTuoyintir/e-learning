...
<div class="space-y-6">
    ...
    <div>
        ...
        <textarea name="description" rows="3"
                  ...
                  class="w-full px-4 py-3 bg-slate-800/90 border border-slate-700/90 rounded-2xl text-slate-100 text-sm focus:bg-slate-800 focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500 transition font-medium placeholder-slate-500">{{ old('description', $quiz->description ?? '') }}</textarea>
    </div>
    ...
    <div>
        ...
        <label
            for="image-upload"
            class="group relative flex flex-col items-center justify-center w-full h-36 border-2 border-dashed border-slate-700 hover:border-indigo-500 rounded-2xl cursor-pointer bg-slate-800/40 hover:bg-slate-800/80 transition duration-200">
            <div class="w-10 h-10 rounded-xl bg-indigo-500/10 group-hover:bg-indigo-600/20 border border-indigo-500/20 text-indigo-400 flex items-center justify-center mb-1.5 transition">
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
        ...
        <div>
            ...
            <select name="difficulty"
                    class="w-full px-4 py-2.5 bg-slate-800/90 border border-slate-700/90 rounded-2xl text-slate-100 text-sm focus:bg-slate-800 focus:ring-2 focus:ring-indigo-500 transition font-medium capitalize">
    ...
    <div class="pt-4 border-t border-slate-800 flex items-center justify-end gap-3">
        <a href="{{ route('quizzes.index') }}" class="px-5 py-2.5 rounded-2xl border border-slate-700 bg-slate-800 text-slate-300 hover:bg-slate-700 font-bold text-xs transition">
            Cancel
        </a>
        <button type="submit"
