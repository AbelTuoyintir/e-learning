...
<div class="space-y-6 max-w-4xl mx-auto">
    ...
    <div class="flex flex-col sm:flex-row sm:items-center justify-between gap-4 bg-slate-900/80 backdrop-blur-md rounded-3xl p-6 sm:p-8 shadow-xl border border-white/10">
        <div class="flex items-center gap-3.5">
            <div class="w-12 h-12 rounded-2xl bg-gradient-to-tr from-purple-600 to-indigo-600 flex items-center justify-center text-white font-bold shadow-lg shadow-purple-500/20">
                <i class="fas fa-pen-to-square text-xl"></i>
            </div>
            <div>
                <h1 class="font-heading text-2xl font-extrabold text-white tracking-tight">Edit Assessment Quiz</h1>
                <p class="text-xs text-slate-400 mt-0.5">Quiz: <span class="font-bold text-indigo-400">{{ $quiz->title }}</span></p>
            </div>
        </div>
