...
<div class="space-y-6 max-w-4xl mx-auto">
    ...
    <div class="flex flex-col sm:flex-row sm:items-center justify-between gap-4 glass-panel rounded-3xl p-6 sm:p-8 shadow-xl">
        <div class="flex items-center gap-3.5">
            ...
            <div>
                <h1 class="text-2xl font-extrabold text-white tracking-tight font-heading">Edit Quiz</h1>
                <p class="text-xs text-slate-400 mt-0.5">Quiz: <span class="font-bold text-indigo-400 font-heading">{{ $quiz->title }}</span></p>
            </div>
        </div>
